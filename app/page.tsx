...
export default function Home() {
  ...
  const foodCategories = [
    ...
    },
    {
      ...
      description: 'Premium non-vegetarian selections',
    },
    {
      title: 'Snacks & Starters',
      image: '/birthday-party-catering.jpg',
      description: 'Appetizing starters and snacks',
    },
    {
      title: 'Traditional Sweets',
      image: '/traditional-sweets.jpg',
      description: 'Handmade traditional sweets',
    },
  ];
      ...
      <main className="min-h-screen">
        ...
        <section className="relative h-screen flex items-center justify-center bg-gradient-to-b from-primary/5 to-secondary/5 overflow-hidden">
          ...
          <div 
            ...
            style={{
              backgroundImage: 'url(/hero-wedding-catering.jpg)',
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
          <div className="max-w-7xl mx-auto">
            <motion.div
              ...
              className="text-center mb-16"
            >
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-4">Our Menu Categories</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Explore our diverse range of authentic dishes for every taste.
              </p>
            </motion.div>
