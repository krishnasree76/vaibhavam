...
export default function NonVegSilverMenuPage() {
      ...
      <main className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                A grand non-vegetarian catering package with welcome drinks,
                starters, premium biryanis, curries, sweets, and traditional
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <Image
                src="/images/nonveg-silver-menu.jpg"
                alt="Non Veg Silver Menu"
                fill
        ...
        <section className="bg-gradient-to-r from-primary to-secondary py-16 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/90 mb-8">
              Contact us to customize this premium non-vegetarian catering
              menu for weddings, receptions, and grand celebrations.
            </p>
