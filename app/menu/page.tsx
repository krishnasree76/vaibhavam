  ...
  const packages = [
    {
      ...
      items: [
        ...
        { name: "Veg Standard", link: "/menu/veg-standard" },
        { name: "Veg Silver Menu", link: "/menu/veg-silver" },
        { name: "Veg Silver Menu-2", link: "/menu/veg-silver-2" },
      ],
    },
    {
      ...
      items: [
        ...
        { name: "Non-Veg Basic-2", link: "/menu/nonveg-basic-2" },
    ...
    },
    {
      ...
      items: [
        { name: "Telangana Special,Andhra Special&Rayalaseema Special", link: "/menu/telangana" },
        // { name: "Andhra Special", link: "/menu/andhra" },
        // { name: "Rayalaseema Special", link: "/menu/rayalaseema" },
      ],
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                Explore our carefully designed vegetarian and non-vegetarian
                catering packages for weddings, events, and celebrations.
              </p>
            </motion.div>
        ...
        <section className="bg-gradient-to-r from-primary to-secondary py-16 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-white/90 mb-8">
                Need a custom catering menu? We can design a package based on
                your event requirements and guest preferences.
              </p>
