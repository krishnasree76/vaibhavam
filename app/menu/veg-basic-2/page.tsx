...
export default function VegBasicMenu2Page() {
      ...
      <main className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h1 className="text-5xl font-bold text-foreground mb-4">
                South Indian Veg Menu - 2
              </h1>

              <p className="text-lg text-muted-foreground">
                Traditional South Indian vegetarian feast with sweets,
                flavored rice, curries, and classic accompaniments.
              </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <Image
                src="/images/south-indian-veg-menu2.jpg"
                alt="South Indian Veg Menu 2"
                fill
        ...
        <section className="bg-gradient-to-r from-primary to-secondary py-16 px-4">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-white/90 mb-8">
              Contact us to customize this catering menu for weddings,
              receptions, or family celebrations.
            </p>
