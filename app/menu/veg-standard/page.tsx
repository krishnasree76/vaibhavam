...
export default function VegStandardMenuPage() {
      ...
      <main className="min-h-screen">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground">
                A complete vegetarian catering menu including sweets, snacks,
                breads, flavored rice, special curries, and traditional South
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-start">
            ...
            >
              <Image
                src="/images/veg-standard-menu.jpg"
                alt="Veg Standard Menu"
                fill
